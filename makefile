...
demo: grVec2.o grCvPoly2.o demo.o grEntity.o
	$(CC) $(CFLAGS) demo.o -o demo grVec2.o grCvPoly2.o grRenderC.o grColliderC.o grEntity.o -lsfml-graphics -lsfml-window -lsfml-system
...
grRenderC.o: grCvPoly2.o grVec2.o
	$(CC) $(CFLAGS) -c components/grRenderC.cpp

grColliderC.o: grCvPoly2.o grVec2.o
...
clean:
	rm -f main grVec2.o grCvPoly2.o grEntity.o grRenderC.o demo.o demo grColliderC.o
